 ...
 * @author user
 */
public class Top10Puntos extends javax.swing.JFrame {

    /**
     * Creates new form Top10Puntos
     */
    public Top10Puntos() {
        initComponents();
        CargarTop();
    ...
    private void initComponents() {
        ...
        lbl_Jugador1.setText("1. Jugador: Jugador(1) ---> Punteo: 0");

        lbl_Jugador2.setFont(new java.awt.Font("Traditional Arabic", 1, 18)); // NOI18N
        lbl_Jugador2.setText("2. Jugador: Jugador(2) ---> Punteo: 0");
        ...
        lbl_titulo1.setText("TOP 10 PUNTOS");
    ...
    public void CargarTop() {
        ...
        for (int i = 0; i < Ordenados.length; i++) {
            labels[i].setText(i+". Jugador: "+Ordenados[Ordenados.length-1-i].getNombre()+" ---> Punteo: "+Ordenados[Ordenados.length-1-i].getPunteo());
            if (i==9) {
                break;
            }
        }
